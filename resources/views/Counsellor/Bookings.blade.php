                ...
                <div class="mt-1 row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">
                                    <i  class="m-r-5 font-18 mdi mdi-numeric-2-box-multiple-outline"></i>Counselling requests</h4>
                                <h6 class="card-subtitle">Client Counselling request bookings</h6>
                            </div>
                                        ...
                                        @foreach ($bookings as $booking)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/Counsellor/Bookings/{{ $booking->id }}" method="POST"  >
                                                        @csrf
