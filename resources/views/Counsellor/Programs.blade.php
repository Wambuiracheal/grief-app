                ...
                <div class="col-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-1 d-flex align-items-center">
                            <li class="breadcrumb-item"><a href="/Counsellor/index" class="link"><i class="mdi mdi-home-outline fs-4"></i></a></li>
                                    ...
                                    <div class="row p-2 mb-4">
                                        <div class="col-md-4">
                                            <div class="mb-0 p-2">
                                                ...
                                                <input type="text" name="ProgramName" class="form-control" placeholder="Child counselling"/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-0 p-2">
                                        ...
                                        <input id="invisible_id" name="CounsellorId" type="hidden" value="{{ $get_counsellor_id->id }}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"> Programs aligned with their respective Days of the week.</h6>
                            </div>
