            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-6">
                    <div class="text-end upgrade-btn">
                        <a href="/Counsellor/Bookings" class="btn btn-primary text-white" >Bookings</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-md-flex">
                            <div>
                                <h4 class="card-title">Counselling records</h4>
                                <h5 class="card-subtitle">Overview of Last counselling sessions</h5>
                            </div>
                            {{-- <div class="ms-auto">
                                <div class="dl">
